        ...
        void OnSceneGUI()
        {
            ...
            if (cp.ShowGizmos)
            {
                ...
                for (int i = 0; i < joints.Length - 1; ++i)
                {
                    ...
                    Handles.DotHandleCap(0, p0, camTr.rotation, m_markerSize.val, Event.current.type);
#else
                ...
                {
#if UNITY_5_5_OR_NEWER
                    Handles.DotHandleCap(0, joints.Last().position, camTr.rotation, m_markerSize.val, Event.current.type);
#else
