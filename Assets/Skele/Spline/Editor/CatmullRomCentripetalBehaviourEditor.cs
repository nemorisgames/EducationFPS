...
namespace MH.Curves
{
    ...
    [CustomEditor(typeof(CatmullRomCentripetalBehaviour))]
    public class CatmullRomCentripetalBehaviourEditor : Editor, ISplineEditor
    {
        ...
        private void DrawPoints(CatmullRomCentripetal spline, Transform tr)
        {
            ...
            for (int i = 0; i < spline.PointCount; ++i)
            {
                ...
                if (Handles.Button(pt, camTr.rotation, ms_ptSize, ms_ptSize, Handles.DotHandleCap) )
#else
...
#if UNITY_5_5_OR_NEWER
                Handles.CircleHandleCap(GUIUtility.GetControlID(FocusType.Passive), tPos, camTr.rotation, ms_ptSize, Event.current.type);
#else
        ...
        public static void DrawSpline(CatmullRomCentripetal spline, Transform owner)
        {
