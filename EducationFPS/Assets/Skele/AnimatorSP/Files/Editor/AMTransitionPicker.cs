...
public class AMTransitionPicker : EditorWindow {
	...
	// resources
	private Texture tex_transition_a = null;
	private Texture tex_transition_b = null;
	private Texture tex_default_view = null;
	private Texture tex_game_view = null;
	private Texture tex_transition_toggle_bg = null;
	private Texture tex_transition_toggle_button_bg = null;
	private Texture texRightArrow = null;// inspector right arrow
	private Texture texLeftArrow = null;	// inspector left arrow
	private Texture tex_angle_0 = null;
	private Texture tex_angle_90 = null;
	private Texture tex_angle_180 = null;
	private Texture tex_angle_270 = null;
	// constants
	...
	void OnGUI() {
		setWindowSize();
		this.titleContent = new GUIContent("Fade: "+(oData.time_numbering ? AMTimeline.frameToTime(key.frame,(float)aData.getCurrentTake().frameRate)+" s" : key.frame.ToString()));
		// load skin
    ...
    void _LoadRes()
    {
        tex_transition_a = (Texture)Resources.Load("am_transition_a");
        tex_transition_b = (Texture)Resources.Load("am_transition_b");
        tex_default_view = (Texture)Resources.Load("am_icon_default_view");
        tex_game_view = (Texture)Resources.Load("am_icon_game_view");
        tex_transition_toggle_bg = (Texture)Resources.Load("am_transition_toggle_bg");
        tex_transition_toggle_button_bg = (Texture)Resources.Load("am_transition_toggle_button_bg");
        ...
        tex_angle_0 = (Texture)Resources.Load("am_angle_0");
        tex_angle_90 = (Texture)Resources.Load("am_angle_90");
        tex_angle_180 = (Texture)Resources.Load("am_angle_180");
        tex_angle_270 = (Texture)Resources.Load("am_angle_270");
    }
	#endregion
	...
	void loadAnimatorData()
	{
        ...
        if (!aData)
            Dbg.LogWarn("AMTransitionPicker.loadAnimatorData: failed to get aData from AnimatorData");
